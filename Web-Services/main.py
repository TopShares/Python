...
if __name__ == '__main__':
    ...
    logging.info("listening to http://192.168.2.238:8080")
    logging.info("wsdl is at: http://192.168.2.238:8080/?wsdl")
    server = make_server('192.168.2.238',8080,wsgi_application)
